package cokr.xit.adds.core.auth.web;
...
public class AuthApiController {
	...
	public ApiBaseResponse<LoginVO> login(@RequestBody final LoginVO loginVO, HttpServletRequest request) {
		// 1. 일반 로그인 처리
		...
		if (loginResultVO != null && loginResultVO.getId() != null && !loginResultVO.getId().equals("")) {
			...
			return ApiBaseResponse.of(loginResultVO);
		}
		throw ApiCustomException.create(messageUtil.getMessage("fail.common.login"));
	}
	...
	public ApiBaseResponse<Map<String,Object>> loginJWT(@RequestBody final LoginVO loginVO, HttpServletRequest request) {
	...
	//		claimsMap.put("dkkdk", "kdkkdkdkd");
	    ...
	    //	System.out.println("Dec jwtToken username = "+username);
		    ...
		    return ApiBaseResponse.of(resultMap);

		}
		throw  ApiCustomException.of("fail.common.login" );
	}
	...
	public  ApiBaseResponse<?> actionLogoutJSON(HttpServletRequest request) {
